...
class EntityType(StrEnum):
    """Stable semantic categories used by extraction and evaluation."""
...
class ExtractedFact:
    """An extracted fact with a reproducible source location.

    Character offsets are measured against the exact normalized text supplied
    to the extractor. ``source_document_sha256`` binds provenance to content,
    preventing a page/span pair from silently referring to a changed file.
    """
